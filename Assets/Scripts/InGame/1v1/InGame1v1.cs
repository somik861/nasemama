...
public class InGame1v1 : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        if (GUI.Button(new Rect(0,0,Screen.width, Screen.height/9),"moje")){
          
        }
        if (GUI.Button(new Rect(0,Screen.height-Screen.height/9,Screen.width-(2*(Screen.width/4)), Screen.height/9),"moje")){
          
        }   
        if (GUI.Button(new Rect(Screen.width/3,Screen.height-Screen.height/9,Screen.width-(2*(Screen.width/2)), Screen.height/9),"moje")){
          
        }
        if (GUI.Button(new Rect(2*Screen.width/3,Screen.height-Screen.height/9,Screen.width-(2*(Screen.width/4)), Screen.height/9),"moje")){
