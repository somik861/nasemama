...
public class GameControler 
{
    ...
    int Player_suroviny_kamen_actual;
    int Player_suroviny_zelezo_actual;
    int Player_suroviny_ropa_actual;
    int Player_suroviny_uran_actual;
    int Player_suroviny_potraviny_actual;
    int Player_suroviny_obyvatele_actual;

    int Ai_suroviny_kamen_actual;
    int Ai_suroviny_zelezo_actual;
    int Ai_suroviny_ropa_actual;
    int Ai_suroviny_uran_actual;
    int Ai_suroviny_potraviny_actual;
    int Ai_suroviny_obyvatele_actual;
